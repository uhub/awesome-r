...
* [thospfuller/rcoboldi](https://github.com/thospfuller/rcoboldi) - An R package for importing COBOL CopyBook data directly into R as properly structured data frames. Package builds are available via Drat and Docker.
