...
* [jalapic/engsoccerdata](https://github.com/jalapic/engsoccerdata) - English and European soccer results 1871-2020
...
* [r-lidar/lidR](https://github.com/r-lidar/lidR) - R package for airborne LiDAR data manipulation and visualisation for forestry application
...
* [covid19datahub/COVID19](https://github.com/covid19datahub/COVID19) - Unified dataset for a better understanding of COVID-19
...
* [nflverse/nflfastR-data](https://github.com/nflverse/nflfastR-data) - Data scraped from nflfastR package
...
* [m-clark/Miscellaneous-R-Code](https://github.com/m-clark/Miscellaneous-R-Code) - Code that might be useful to others for learning/demonstration purposes, specifically along the lines of modeling and various algorithms. Now almost entirely superseded by the models-by-example repo.
...
* [immunomind/immunarch](https://github.com/immunomind/immunarch) - 🧬 Immunarch by ImmunoMind: R Package for Fast and Painless Exploration of Single-cell and Bulk T-cell/Antibody Immune Repertoires
...
* [emitanaka/edibble](https://github.com/emitanaka/edibble) - An R-package to construct designs using the grammar of experimental design
...
* [ChristophH/sctransform](https://github.com/ChristophH/sctransform) - R package for modeling single cell UMI expression data using regularized negative binomial regression
...
* [ropensci-archive/umapr](https://github.com/ropensci-archive/umapr) - :no_entry: ARCHIVED :no_entry: UMAP dimensionality reduction in R
...
* [trevorld/r-optparse](https://github.com/trevorld/r-optparse) - R package providing a command line optional argument parser
...
* [jorvlan/raincloudplots](https://github.com/jorvlan/raincloudplots) - The easy way to create raincloud plots
...
* [dlab-berkeley/Deep-Learning-in-R](https://github.com/dlab-berkeley/Deep-Learning-in-R) - Workshop (6 hours): Deep learning in R using Keras. Building & training deep nets, image classification, transfer learning, text analysis, visualization
...
* [calthaus/ncov-cfr](https://github.com/calthaus/ncov-cfr) - R code and documentation to estimate case fatality ratio of COVID-19 from cases outside China
...
* [robjhyndman/fpp2-package](https://github.com/robjhyndman/fpp2-package) - All data sets required for the examples and exercises in the book "Forecasting: principles and practice" (2nd ed, 2018) by Rob J Hyndman and George Athanasopoulos <http://OTexts.org/fpp2/>.  All packages required to run the examples are also loaded.
...
* [jhelvy/xaringanBuilder](https://github.com/jhelvy/xaringanBuilder) - An R package for building xaringan slides into multiple outputs, including html, pdf, png, gif, pptx, and mp4.
...
* [haven-jeon/KoNLP](https://github.com/haven-jeon/KoNLP) - R package for Korean NLP
...
* [mrcaseb/nflfastR](https://github.com/mrcaseb/nflfastR) - A Set of Functions to Efficiently Scrape NFL Play by Play Data
* [guga31bb/nflfastR-data](https://github.com/guga31bb/nflfastR-data) - Data scraped from nflfastR package
...
* [neo4j-rstats/neo4r](https://github.com/neo4j-rstats/neo4r) - A Modern and Flexible Neo4J Driver
...
* [mitchelloharawild/icon](https://github.com/mitchelloharawild/icon) - R package to easily insert web icons to RMarkdown
...
* [klmr/pod](https://github.com/klmr/pod) - Write reusable, composable and modular R code
...
* [nset-ornl/wbstats](https://github.com/nset-ornl/wbstats) - wbstats: An R package for searching and downloading data from the World Bank API
...
* [wlandau/targets](https://github.com/wlandau/targets) - Function-oriented Make-like declarative workflows for R
...
* [YinLiLin/R-CMplot](https://github.com/YinLiLin/R-CMplot) - 📊 Circular and Rectangular Manhattan Plot
...
* [thospfuller/rcoboldi](https://github.com/thospfuller/rcoboldi) - Import COBOL CopyBook data files directly into R as properly structured data frames. Package builds are available via [Drat](https://github.com/thospfuller/drat) and [DockerHub](https://hub.docker.com/r/thospfuller/rcoboldi-rocker-rstudio).
